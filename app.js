...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className = "task-tiem__checkbox";
    //label
    ...
    editButton.className="task-item__edit-btn btn edit-btn";

    deleteButton.className="task-item__delete-btn btn delete-btn";
